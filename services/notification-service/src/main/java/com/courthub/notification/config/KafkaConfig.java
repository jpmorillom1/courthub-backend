...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, BookingEventPayload> consumerFactory() {
        ...
        config.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "com.courthub.notification.event.BookingEventPayload");

        config.put(JsonDeserializer.TRUSTED_PACKAGES, "com.courthub.*");
